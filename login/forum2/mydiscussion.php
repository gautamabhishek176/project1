...
<div class="new">
  ...
  <button type="button" onclick="location.href='../login/loginpage.php?req1=2112'"> <!--onclick location.href-->Create Discussion</button>
</div>
...
?>
  <a href="./loginpage.php?req1=2114&&id=<?php echo $des_user_ida;?>"><div class="inpost">
		...
		<p class="desc"> Description:<?php echo $query_execute2['contentt']; ?></p>
		 ...
		 <div class="options">
      <a class="edit" href="./loginpage.php?req1=2115&&bd=<?php if(isset($des_user_ida)){echo $des_user_ida;}?>">Edit Post</a>
      <a class="delete" href="./loginpage.php?req1=2113" onclick="return fanc(<?php echo $des_user_ida;?>);" id="dela">Delete Post</a>
</div>
