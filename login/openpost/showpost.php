...
<div class="inpost">
    ...
    <div class="dlink">
    <a class="delete" href="<?php echo  $des_user_addrb;?>" download="attachedfile">Download attached files</a>
    </div> <?php 
		}?>
    <div class="cpng">
...
<div class="drop2">
  <a href="./loginpage.php?req1=2115&&bd=<?php if(isset($des_user_idb)){echo $des_user_idb;}?>">Edit Post</a>
  <a href="./loginpage.php?req1=2113" onclick="return fanc(<?php echo $des_user_idb; ?>);" id="dela">Delete Post</a>
</div>
</div>
<?php
}
