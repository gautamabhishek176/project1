...
if(loggedin()){
    ...
    if(isset($_GET['request'])){ // for office query
		   if($_GET['request']==6111){
			   include 'academicstatus/acedemic.php';
		     }
	}else{
		  ...
		  if(isset($_GET['requ'])){
		  if($_GET['requ']==3111){
			 include 'ts_query/query/query.php'; 
		  }else{if($_GET['requ']==3112){
			 include 'ts_query/openquery/openquery.php';
		    }else{
				if($_GET['requ']==3113){
			 include 'ts_query/newquery/querypost.php';
		    }else{
